        ...
        <div class="dropdown-content">
            <a href="/CursosLibres/CursoDisplay">Inicio</a>
                ...
                <% if (usuario.getClass().getSimpleName().equals("Estudiante")){ %>
                    <a href="/CursosLibres/presentation/usuario/Estudiante/matricular.jsp">Matricular</a>
                ...
                <% if (tipoUsr.equals("Administrador")){%>
                    ...
                    <a href="/CursosLibres/presentation/usuario/Administrador/Profesor/profesor.jsp">Administrar Profesores</a>
                    <a href="/CursosLibres/Logout">Logout</a>
                <% }%>  
                <% } else {%> 
