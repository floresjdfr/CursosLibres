            ...
            <table>
               ...
               <% if (lista.profesoresList() != null) {
                     for (Profesor c : lista.profesoresList()) {
                        ...
                        String urlVerInfo = "/CursosLibres/verProfeShow?idProfesor=" + c.getCedula();;
               %>
               <tr>
                  <td><%=c.getNombre()%></td>
                  <td>
                     <button type="button" onclick="location.href = '<%=urlVerInfo%>'" class="table-btn">Ver informacion</button>
                  </td>
                  <td>
